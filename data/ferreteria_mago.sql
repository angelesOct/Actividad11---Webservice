CREATE DATABASE ferreteria_mago;
...
CREATE TABLE clientes(
    id_clientes varchar(100) not null PRIMARY KEY,
...
VALUES ('Maria de los Angeles','Gayosso','Octaviano','7757584354','annggii199@gmail.com'),
       ('Alexis Andres','Hernandez','Ramirez','7765849213','alexis@gmail.com'),
       ('Luisa','Octaviano','Sebastian','66574849203','luisa@outlook.com');
...
CREATE USER 'ferreteriaMago'@'localhost' IDENTIFIED BY 'ferreteriaMago.2019';
GRANT ALL PRIVILEGES ON ferreteria_mago.* TO 'ferreteria'@'localhost';
FLUSH PRIVILEGES;